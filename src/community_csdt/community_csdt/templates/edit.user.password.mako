...
<%block name="title">
  <title>CSDT Community | ${owner} | Change Account Password</title>
</%block>
...
<div class="content content_resize_main body-sticky-footer mainbar">
  ...
  <div class="article">
    ...
    <h3><a href="/accounts/${owner}/admin/profile/edit">Edit Account Profile</a> | <a href="${full_url}">Change Account Password</a> | <a href="/accounts/${owner}/admin/email/edit">Change Account Email</a></h3>
    <br/>
